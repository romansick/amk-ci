 ...
 <div class="content-body">
     ...
     <div class="container-fluid">
         ...
         <div class="row">
             <div class="col-12">
                 <a href="<?= base_url('administrasi/transaksi'); ?>" type="button" class="btn btn-info mb-3">
                     << Kembali </a>
                         <div class="card">
                             <div class="card-header">
                                 <h4 class="card-title"><?= $tipe['nama_tipe'] ?>, Blok <?= $transaksi['blok']; ?>, Nomor <?= $transaksi['nomor']; ?>, <?= $lokasi['lokasi']; ?></h4>
                                 <a href="<?= base_url('administrasi/add_pesanan_custom/') . $transaksi['id']; ?>" type="button" class="btn btn-primary">+ Tambah</a>
                             </div>
                             <div class="card-body">
