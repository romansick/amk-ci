                                ...
                                <tbody>
                                    ...
                                    foreach ($transaksi as $t) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('pimpinan/custom_pesanan/') . $t['id']; ?> " type="button" class="btn btn-primary btn-sm">+Custom</a>
                                            ...
                                            <td>
                                                <a href="<?= base_url('pimpinan/cetak/') . $t['id']; ?>" target="_blank" type="button" class="btn btn-sm btn-primary"> <i class="fa fa-print"></i> Print
                                                </a>
                                            </td>
                                        </tr>
                                    <?php $i++;
