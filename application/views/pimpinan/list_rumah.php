                                                    ...
                                                    foreach ($rumah as $r) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?= base_url('pimpinan/galleri/') . $r['id']; ?>" type="button" class="btn btn-info btn-sm mr-3">Gallery <span class="btn-icon-right"><i class="fa fa-edit"></i></span>
                                                                </a>

                                                                <a href="<?= base_url('pimpinan/editrumah/') . $r['id']; ?>" type="button" class="btn btn-warning btn-sm">Edit <span class="btn-icon-right"><i class="fa fa-edit"></i></span>
                                                                </a>
            ...
            <?php foreach ($list as $r) : ?>
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card">
                        ...
                        <?php } ?>
                        <a href="<?= base_url('pimpinan/detail/') . $r['id']; ?>" type="button" class="btn btn-info btn-sm mt-3">Detail
                        </a>
                    </div>
                </div>
            <?php endforeach; ?>
