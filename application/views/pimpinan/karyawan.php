                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($k['is_active'] == 1) : ?>
                                                        <a href="<?= base_url('pimpinan/karyawan_nonactive/') . $k['id'] ?>" type="button" class="badge badge-rounded badge-success">Active</a>
                                                    <?php else : ?>

                                                        <a href="<?= base_url('pimpinan/karyawan_active/') . $k['id'] ?>" type="button" class="badge badge-rounded badge-danger">Non Active</a>
                                                    <?php endif; ?>
                                                    <a href="<?= base_url('pimpinan/karyawan_delete/') . $k['id'] ?>" type="button" class="badge badge-rounded badge-danger">Delete</a>
                                                </td>
    ...
    <div class="modal fade" id="basicModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('pimpinan/register'); ?>" method="post">
