                                ...
                                <div id="default_collapseOne" class="collapse accordion__body show" data-parent="#accordion-one">
                                    <div class="accordion__body--text">
                                        <div class="d-flex justify-content-between pb-3">
                                            <div></div>
                                            <a href="<?= base_url('administrator/addhouse/') .  $lokasi['id']; ?>" type="button" class="btn btn-rounded btn-info"><span class="btn-icon-left text-info"><i class="fa fa-plus color-info"></i>
                                                </span>Tambah Rumah
                                            </a>
                                        </div>
                                                    ...
                                                    foreach ($rumah as $r) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?= base_url('administrator/galleri/') . $r['id']; ?>" type="button" class="btn btn-info btn-sm mr-3">Gallery <span class="btn-icon-right"><i class="fa fa-edit"></i></span>
                                                                </a>

                                                                <a href="<?= base_url('administrator/editrumah/') . $r['id']; ?>" type="button" class="btn btn-warning btn-sm">Edit <span class="btn-icon-right"><i class="fa fa-edit"></i></span>
                                                                </a>
                                                                <?php if ($r['status'] == 'AVAILABLE') : ?>
                                                                    <a href="<?= base_url('administrator/deleterumah/') . $r['id']; ?>" type="button" class="btn btn-danger btn-sm ml-3">Delete <span class="btn-icon-right"><i class="fa fa-trash"></i></span>
                                                                    </a>
                                                                <?php else : ?>
                                                                    <div></div>
                                                                <?php endif; ?>
            ...
            <?php foreach ($list as $r) : ?>
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card">
                        ...
                        <?php } ?>
                        <a href="<?= base_url('administrator/detail/') . $r['id']; ?>" type="button" class="btn btn-info btn-sm mt-3">Detail
                        </a>
                    </div>
                </div>
            <?php endforeach; ?>
