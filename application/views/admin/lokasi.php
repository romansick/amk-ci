                                ...
                                <tbody>
                                    ...
                                    foreach ($lokasi as $l) : ?>
                                        <tr>
                                            ...
                                            <td> <?= $l['lokasi']; ?></td>
                                            <td>
                                                <a type="button" href="<?= base_url('administrator/listrumah/') . $l['id']; ?>" class="btn btn-info btn-sm mr-3">List Rumah <span class="btn-icon-right"><i class="fa fa-home"></i></span>
                                                </a>
                                                <a href="<?= base_url('administrator/edit_lokasi/') . $l['id']; ?>" type="button" class="btn btn-warning btn-sm">Edit <span class="btn-icon-right"><i class="fa fa-edit"></i></span>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php $i++;
