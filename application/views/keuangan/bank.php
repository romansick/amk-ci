                                ...
                                <tbody>
                                    ...
                                    foreach ($bank as $b) : ?>
                                        <tr>
                                            ...
                                            <td> <?= $b['pemilik']; ?></td>
                                            <td>
                                                <a href="<?= base_url('keuangan/editbank/') .  $b['id']; ?>" type="button" class="btn btn-warning btn-sm">Edit <span class="btn-icon-right"><i class="fa fa-edit"></i></span>
                                                </a>

                                                <a href="<?= base_url('keuangan/deletebank/') . $b['id']; ?>" type="button" class="btn btn-danger btn-sm ml-3" onclick="return confirm('Data akan dihapus?')">Delete <span class="btn-icon-right"><i class="fa fa-trash"></i></span>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php $i++;
