                                                    ...
                                                    foreach ($rumah as $r) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?= base_url('keuangan/galleri/') . $r['id']; ?>" type="button" class="btn btn-info btn-sm mr-3">Gallery <span class="btn-icon-right"><i class="fa fa-edit"></i></span>
                                                                </a>
            ...
            <?php foreach ($list as $r) : ?>
                <div class="col-xl-3 col-xxl-3 col-sm-6">
                    <div class="card">
                        ...
                        <?php } ?>
                        <a href="<?= base_url('keuangan/detail/') . $r['id']; ?>" type="button" class="btn btn-info btn-sm mt-3">Detail
                        </a>
                    </div>
                </div>
            <?php endforeach; ?>
