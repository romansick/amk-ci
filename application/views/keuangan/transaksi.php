                                ...
                                <tbody>
                                    ...
                                    foreach ($transaksi as $t) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('keuangan/custom_pesanan/') . $t['id']; ?> " type="button" class="btn btn-primary btn-sm">+Custom</a>
                                            ...
                                            <td>
                                                <?php if ($t['status'] == 0) { ?>
                                                    <!-- <a href="<?= base_url('keuangan/konfirmasi/') . $t['id']; ?>"> -->
                                                    <span class="badge badge-warning">Belum Dikonfirmasi</span>
                                                    <div class="flex mt-3">
                                                        <a href="<?= base_url('keuangan/terima/') . $t['id']; ?>" class="btn btn-primary btn-xs">Terima</a>
                                                        <a href="<?= base_url('keuangan/tolak/') . $t['id']; ?>" class="btn btn-danger btn-xs">Tolak</a>
                                                    </div>
                                                    <!-- </a> -->
                                            ...
                                            <td>
                                                <a href="<?= base_url('keuangan/cetak/') . $t['id']; ?>" target="_blank" type="button" class="btn btn-sm btn-primary"> <i class="fa fa-print"></i> Print
                                                </a>
                                            </td>
                                        </tr>
                                    <?php $i++;
